...
func main() {
	...
	logLevel := mergeEnvValue("TROUBLESHOOTING_PANEL_CONSOLE_PLUGIN_LOG_LEVEL", *logLevelArg, "trace") // JZ TODO: change this back to 'error'
